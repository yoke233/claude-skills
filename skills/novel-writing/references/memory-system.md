...
**上下文包**（`00-项目/工作流/上下文包-章XXX.md`）是搜集员的产出物，按 `_模板/上下文包模板.md` 结构组装，包含 11 个区域：本章任务、防翻车指令、风格约束、去AI味规则、世界观速查、术语表、出场角色、场景地点、前文衔接、技法约束、按需技法要点。写手 Agent 只需读这一个文件即拥有完整上下文。
...
`00-项目/项目索引.md` 是 agent 了解项目全局状态的**唯一入口**。新会话开始时先读此文件，无需逐目录探索。写后即录 Batch 4 自动维护，内容包括：角色/地点/势力清单（含文件路径）、活跃伏笔、活跃情节线、卷进度、最近变更。
